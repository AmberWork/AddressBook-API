...
router
  .route("/users")
  .post(
    FileUploader.uploadFile("Profile").single("profile_image"),
...
router.route("parishes/:id").get(ParishController.getParishById);
